import { buildDataset, type IcgDataset } from "@icg/data";
import type { CloseInput } from "../src/index.js";

/**
 * Test-side assembly of CloseInput from the generated dataset. In Stage 04
 * the application services perform this wiring; packages/rules itself never
 * depends on @icg/data (dependency direction).
 */
